...
print(f"Foci: ({F1[0,0]:.2f}, {abs(F1[1,0]):.2f}) and ({F1[0,0]:.2f}, -{abs(F1[1,0]):.2f})")
print(f"Vertices: ({V1[0,0]:.1f}, {abs(V1[1,0]):.1f}) and ({V1[0,0]:.1f}, -{abs(V1[1,0]):.1f})")
print(f"Eccentricity (e): {e:.2f}")
print("Major Axis: x=0")
print(f"Equation of the Directrices: y = {directrix1_y:.2f} and y = -{directrix1_y:.2f}")
