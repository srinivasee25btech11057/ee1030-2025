...
# Define coefficients from the problem: 3/x + 2/y = 12 and 2/x + 3/y = 13
a1, b1, c1 = 3.0, 2.0, 12.0
a2, b2, c2 = 2.0, 3.0, 13.0
...
if success:
    ...
    # For this system, the C function works directly as intended.
    x_point = x_sol.value
    y_point = y_sol.value
