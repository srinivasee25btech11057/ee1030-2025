...
void eigen_2x2(double A[2][2], double eigenvalues[2],
  ...
  // Step 2: Store the given eigenvectors from options (a), (b), (c)
  eigenvectors[0][0] = 1.0; // Option a: (1,0)
  eigenvectors[0][1] = 0.0;

  eigenvectors[1][0] = -2.0; // Option b: (-2,1)
  eigenvectors[1][1] = 1.0;

  eigenvectors[2][0] = 4.0; // Option c: (4,-3)
  eigenvectors[2][1] = -3.0;
}
