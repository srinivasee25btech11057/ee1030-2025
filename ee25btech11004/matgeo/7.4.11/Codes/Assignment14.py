...
c_lib = ctypes.CDLL('./14c.so')

c_lib.slopee.argtypes = [ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float]
c_lib.slopee.restype = ctypes.c_float
...
slope1 = c_lib.slope(
    ctypes.c_float(0),
    ctypes.c_float(1), 
    ctypes.c_float(answer1[0]),
    ctypes.c_float(answer1[1])
)

slope2 = c_lib.slope(
    ctypes.c_float(0),
    ctypes.c_float(1), 
    ctypes.c_float(answer2[0]),
    ctypes.c_float(answer2[1])
)
